...
print("WebClaw is the intelligence layer for all 21 agents. It is NOT a URL relay.")
print("It must analyze, extract meaning, and return intelligent details to agents.")
print("")
print("REFERENCES DIRECTORY: agents/webclaw/references/")
print("  Each agent has its own subdirectory with domain knowledge files:")
print("  claw_coder/ - 80+ technology categories (python, rust, react, etc.)")
print("  lawclaw/    - 3,800+ city jurisdictions (courts, police, hospitals)")
print("  mediclaw/   - 91 medical specialties")
print("  txclaw/     - 60+ blockchain documentation categories")
print("  draftclaw/  - 4,744 building code entries")
print("  + 14 more agent namespaces with design, math, language resources")
print("")
print("CRITICAL: WebClaw must return INTELLIGENCE, not raw search results.")
print("CRITICAL BUG: Searches not namespace-scoped. Causes contamination.")
print("  DocuClaw gets Morgan docs + Sologenic APIs in wedding invitations.")
print("  Fix: scope searches to calling agent namespace.")
