...
# derivative.py
(Path(r'C:\Users\greg\dev\clawpack_v2\agents\mathematicaclaw\handlers\calculus') / '__init__.py').write_text('from .derivative import derivative\nfrom .integral import integral\nfrom .limit import limit_func\nfrom .proof import proof\n', encoding='utf-8')

(Path(r'C:\Users\greg\dev\clawpack_v2\agents\mathematicaclaw\handlers\calculus') / 'derivative.py').write_text('''"""Step-by-step derivative computation"""
import sympy as sp
