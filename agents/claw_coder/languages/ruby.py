...
class RubyLanguage(BaseLanguage):
    ...
    def generate(self, prompt: str, context: str = "") -> str:
        full_prompt = f"Generate ruby code for: {prompt}\n\nGenerate idiomatic ruby code:"
    ...
    def refactor(self, code: str, suggestion: str) -> str:
        prompt = f"Refactor this ruby code: {suggestion}\n\nCode:\n{code}"
    ...
    def _call_ai(self, prompt: str) -> str:
        try:
            ...
            if response.status_code == 200:
                return response.json().get("response", f"// ruby generation failed")
        except:
            pass
        return f'// Generated ruby code\n// 💎 Language: ruby\n\nfunction main() {{\n    console.log("Hello, World!");\n}}\n'
