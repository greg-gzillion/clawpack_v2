...
class MakefileLanguage(BaseLanguage):
    name = "makefile"
    ...
    def generate(self, prompt: str, context: str = "") -> str:
        full_prompt = f"Generate makefile code for: {prompt}"
    ...
    def _call_ai(self, prompt: str) -> str:
        try:
            ...
            if response.status_code == 200:
                return response.json().get("response", f"// makefile generation failed")
        except:
            pass
        return f'// Generated makefile code\n// 🔧 Language: makefile\n'
