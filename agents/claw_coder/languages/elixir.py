...
class ElixirLanguage(BaseLanguage):
    name = "elixir"
    extensions = ['.ex', '.exs']
    compilers = ['elixir']
    ...
    def _call_ai(self, prompt: str) -> str:
        try:
            ...
            if response.status_code == 200:
                return response.json().get("response", f"// elixir generation failed")
        except:
            pass
        return f'// Generated elixir code\n// 💧 Language: elixir\n\nfunction main() {{\n    console.log("Hello, World!");\n}}\n'
