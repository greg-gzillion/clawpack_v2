...
class ObjectivecLanguage(BaseLanguage):
    name = "objectivec"
    extensions = ['.m', '.h']
    compilers = ['clang']
    ...
    def generate(self, prompt: str, context: str = "") -> str:
        full_prompt = f"Generate objectivec code for: {prompt}\n\nGenerate idiomatic objectivec code:"
    ...
    def _call_ai(self, prompt: str) -> str:
        try:
            ...
            if response.status_code == 200:
                return response.json().get("response", f"// objectivec generation failed")
        except:
            pass
        return f'// Generated objectivec code\n// 🍏 Language: objectivec\n\nfunction main() {{\n    console.log("Hello, World!");\n}}\n'
