...
class FortranLanguage(BaseLanguage):
    name = "fortran"
    ...
    def generate(self, prompt: str, context: str = "") -> str:
        full_prompt = f"Generate fortran code for: {prompt}"
    ...
    def _call_ai(self, prompt: str) -> str:
        try:
            ...
            if response.status_code == 200:
                return response.json().get("response", f"// fortran generation failed")
        except:
            pass
        return f'// Generated fortran code\n// 🔢 Language: fortran\n'
