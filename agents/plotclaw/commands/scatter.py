"""Scatter command - Scatter plots with trendline"""
import os
...
def run(args):
    if not args:
        return "Usage: /scatter <x1,x2,...> <y1,y2,...> [--trendline] [--title Title] [--xlabel X] [--ylabel Y] [--theme dark] [--format svg|pdf|png] [--save-only]\nExample: /scatter 1,2,3,4,5 2,4,6,8,10 --trendline"
    try:
