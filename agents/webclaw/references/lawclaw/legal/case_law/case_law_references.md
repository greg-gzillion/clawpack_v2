# CASE LAW - Complete Legal Reference
...
5. Update with Shepardizing/KeyCite
6. Apply to facts and analyze
...
- **Bankruptcy Courts**
- **Specialized Courts** (Tax, Claims, International Trade)

### State Court Systems
- **Courts of Last Resort** (State Supreme Courts)
- **Intermediate Appellate Courts**
- **Trial Courts of General Jurisdiction**
- **Limited Jurisdiction Courts** (Small claims, probate, family)

### Case Reporters
- **Federal** - Supreme Court Reporter, F.Supp., F.3d
- **Regional** - Atlantic, Pacific, North Eastern, etc.
- **State** - Official state reporters
...
### Federal Statutes
- **US Code (USC)** - Official codification
- **US Code Annotated (USCA)** - Westlaw
- **US Code Service (USCS)** - Lexis
- **Statutes at Large** - Chronological laws

### Popular Name Tables
- Find statutes by common name (e.g., "Civil Rights Act")
- Cross-reference to USC citations
- Historical versions and amendments

### Legislative History
- **Congressional Record** - Floor debates
- **Committee Reports** - House and Senate
- **Hearings** - Testimony transcripts
- **Bill versions** - As introduced, reported, passed
...
### Federal Regulations
- **Code of Federal Regulations (CFR)** - Current rules
- **Federal Register (FR)** - Daily proposed/final rules
- **Agency websites** - Specific agency regulations
...
### US Constitution
- **Full Text**: https://www.archives.gov/founding-docs/constitution
- **Amendment process**
...
- Competence (Rule 1.1)
- Fees (Rule 1.5)
- Duties to court (Rule 3.3)

### State Ethics Rules
- Each state adopts variations of Model Rules
...
- **Motions** - Dismiss, summary judgment, in limine
- **Trial** - Jury selection, evidence, verdict
- **Appeal** - Notice of appeal, briefs, oral argument

### State Civil Procedure
- State-specific rules
- Variations from FRCP
- Limited jurisdiction procedures
...
1. Investigation
2. Arrest
3. Charging (complaint, indictment)
...
- **Rule 501** - Privileges
- **Rule 601-606** - Witness competency
- **Rule 701-706** - Opinion testimony
- **Rule 801-807** - Hearsay

### Types of Evidence
- **Direct** - Proves fact without inference
- **Circumstantial** - Requires inference
- **Real** - Physical objects
- **Documentary** - Writings, recordings
- **Demonstrative** - Diagrams, models
...
- Punitive (punishment, deterrence)
- Nominal damages
...
### Real Property
- **Freehold estates** - Fee simple, life estate
- **Leasehold estates** - Term of years, periodic tenancy
- **Concurrent ownership** - Joint tenancy, tenancy in common
- **Servitudes** - Easements, covenants
- **Landlord-tenant** - Lease agreements, eviction
- **Land use** - Zoning, environmental regulations

### Personal Property
- **Acquisition** - Purchase, gift, inheritance
...
### Agency Structure
- **Executive agencies** - Cabinet departments
...
### At-Will Employment
- Presumption of at-will
- Exceptions (public policy, implied contract)
...
- **Everlaw** - Cloud discovery
- **Logikcull** - Automated discovery

### Document Automation
- **HotDocs** - Document assembly
- **TheFormTool** - Automated documents
- **Contract Express** - Contract automation
...
3. Shepardize/KeyCite all cases
4. Document research trail
5. Update regularly

### Writing Best Practices
1. Know your audience (court, client, opposing counsel)
2. Organize clearly
3. Use headings and formatting
